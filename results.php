        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="sidebarCollapse">
                ...
                <ul class="navbar-nav mb-md-4">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="#" id="results_php_btn">
                            ...
                            <table class="table table-sm table-nowrap card-table">
                                ...
                                <tbody class="list">
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <a href="viewResult.php" class="btn btn-primary text-white btn-sm">View</a>
                                            <a target="_blank" href="print-result.php" class="btn btn-warning text-white btn-sm">Print</a>
                                        </td>
                                    </tr>
                                    <tr>
                                </tbody>
